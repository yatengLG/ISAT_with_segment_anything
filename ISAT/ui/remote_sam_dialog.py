...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_name = QtWidgets.QLabel(self.widget_info)
        ...
        self.label_dtype = QtWidgets.QLabel(self.widget_info)
        self.label_dtype.setText("")
        self.label_dtype.setObjectName("label_dtype")
        self.horizontalLayout_4.addWidget(self.label_dtype)
