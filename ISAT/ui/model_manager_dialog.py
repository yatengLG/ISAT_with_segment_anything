...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.pushButton_checkpoint_dir = QtWidgets.QPushButton(self.widget_2)
        self.pushButton_checkpoint_dir.setFocusPolicy(QtCore.Qt.ClickFocus)
        self.pushButton_checkpoint_dir.setObjectName("pushButton_checkpoint_dir")
        self.horizontalLayout.addWidget(self.pushButton_checkpoint_dir)
