...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.listWidget_category = QtWidgets.QListWidget(Form)
        self.listWidget_category.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.listWidget_category.setSelectionMode(QtWidgets.QAbstractItemView.NoSelection)
        self.listWidget_category.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        ...
        self.pushButton_group_mode.setMinimumSize(QtCore.QSize(80, 25))
        self.pushButton_group_mode.setMaximumSize(QtCore.QSize(80, 25))
        ...
        self.pushButton_decrease.setMinimumSize(QtCore.QSize(25, 25))
        self.pushButton_decrease.setMaximumSize(QtCore.QSize(25, 25))
        ...
        self.lineEdit_currentGroup.setMinimumSize(QtCore.QSize(0, 25))
        self.lineEdit_currentGroup.setMaximumSize(QtCore.QSize(16777215, 25))
        ...
        self.pushButton_increase.setMinimumSize(QtCore.QSize(25, 25))
        self.pushButton_increase.setMaximumSize(QtCore.QSize(25, 25))
