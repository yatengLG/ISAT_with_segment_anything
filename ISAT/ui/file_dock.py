...
# Form implementation generated from reading ui file '/media/lg/disk2/PycharmProjects/ISAT_with_segment_anything/ISAT/ui/file_dock.ui'
#
...
"border-radius: 3px;")
        ...
        self.label_next2_state = QtWidgets.QLabel(self.widget_state)
        self.label_next2_state.setMaximumSize(QtCore.QSize(50, 8))
        self.label_next2_state.setStyleSheet("background-color: rgb(153, 153, 153);\n"
"border-radius: 3px;")
        self.label_next2_state.setText("")
        self.label_next2_state.setObjectName("label_next2_state")
        self.horizontalLayout_2.addWidget(self.label_next2_state)
        self.label_next3_state = QtWidgets.QLabel(self.widget_state)
        self.label_next3_state.setMaximumSize(QtCore.QSize(50, 8))
        self.label_next3_state.setStyleSheet("background-color: rgb(153, 153, 153);\n"
"border-radius: 3px;")
        self.label_next3_state.setText("")
        self.label_next3_state.setObjectName("label_next3_state")
        self.horizontalLayout_2.addWidget(self.label_next3_state)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_next_state.setStatusTip(_translate("Form", "Next 1 image SAM state"))
        self.label_next_state.setWhatsThis(_translate("Form", "Next 1 image SAM state."))
        self.label_next2_state.setStatusTip(_translate("Form", "Next 2 image SAM state"))
        self.label_next2_state.setWhatsThis(_translate("Form", "Next 1 image SAM state."))
        self.label_next3_state.setStatusTip(_translate("Form", "Next 3 image SAM state"))
        self.label_next3_state.setWhatsThis(_translate("Form", "Next 3 image SAM state."))
