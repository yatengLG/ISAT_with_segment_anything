...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionBuildExe = QtWidgets.QAction(MainWindow)
        icon39 = QtGui.QIcon()
        icon39.addPixmap(QtGui.QPixmap(":/icon/icons/转换文件1_file-conversion-one.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionBuildExe.setIcon(icon39)
        self.actionBuildExe.setObjectName("actionBuildExe")
        ...
        self.menuTools.addSeparator()
        self.menuTools.addAction(self.actionBuildExe)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionBuildExe.setText(_translate("MainWindow", "Build EXE"))
        self.actionBuildExe.setStatusTip(_translate("MainWindow", "Package ISAT as standalone executable"))
