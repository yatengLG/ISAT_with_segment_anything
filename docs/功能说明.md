...
16. [多边形交、并、差、异或](https://github.com/yatengLG/ISAT_with_segment_anything/blob/master/docs/功能说明.md#16交并差异或)
...
提供两个多边形的交集、并集、差集、异或运算。
## 交集
![交集.gif](../display/交集.gif)

## 并集
![并集.gif](../display/并集.gif)

## 差集
![差集.gif](../display/差集.gif)

## 异或
![异或.gif](../display/异或.gif)
